...
<th>Option 2</th>
 ...
 <?php
  	...
  	$query = $mysqli->query("SELECT * FROM phpmyreservation_reservations WHERE reservation_user_id = '{$_SESSION['ses_member_id']}' AND reservation_status = '3'  ORDER BY reservation_made_time DESC ")or die('error '.$mysqli->error); 
...
<button style="letter-spacing: 1px; line-height: 1; text-transform: capitalize; font-size: 12px; font-weight: 400;" type="button" class="btn btn-success btn-sm">Enter Session</button>
</a>';
