...
if ($mysqli->connect_error) {
    ...
    $user_id = $_SESSION['ses_member_id'];
	if($user_id == $counsellor_idx ){
	return('You can\'t perform this action here, You can\'t remove others booking');
	} 
