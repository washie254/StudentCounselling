...
$page_title = "My Bookings - ".$consultant->first_name." ".$consultant->last_name; ?> 
...
<div style="text-align: center; font: 28px bold; background: #fff; margin-bottom: -20px; padding-top: 15px; padding-bottom: 20px;">My Bookings: <strong><?php echo $consultant->first_name." ".$consultant->last_name; ?></strong> </div>
