...
<?php include("../header_menu.php"); ?> 
   ...
   <div style="margin-bottom: 120px;" > </div>
		...
		<a href="/CounsellingSystem/chat-session/end_chat.php?id=<?php echo $reservation_id; ?>">
		<button style="letter-spacing: 1px; line-height: 1; text-transform: capitalize; font-size: 12px; font-weight: 400; float: right;" type="button" class="btn btn-success btn-sm">End Session</button>
		</a>
